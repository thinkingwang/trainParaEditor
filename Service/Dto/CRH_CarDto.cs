...
namespace Service.Dto
{
    public class CRH_CarDto : Dto
    {
        ...
        private static readonly int comboBoxColumnIndex1 = 5; // DataGridView的首列
        private readonly CRH_Car _crhCarTemp;
        ...
        public byte carPos
        {
            get { return (byte) (_crhCarTemp.carPos + 1); }
            set { _crhCarTemp.carPos = value; }
        }

        [DisplayName("车厢编号")]
        public string carNo
        {
            get { return _crhCarTemp.carNo; }
            set { _crhCarTemp.carNo = value; }
        }

        [DisplayName("车轴编号")]
        public string axleType
        {
            get { return _crhCarTemp.axleType; }
            set { _crhCarTemp.axleType = value; }
        }
        ...
        public bool dir
        {
            get { return _crhCarTemp.dir; }
            set { _crhCarTemp.dir = value; }
        }
        ...
        private static void _dgv_CellValueChanged(object sender, DataGridViewCellEventArgs e)
        {
            ...
            Nlogger.Trace("编辑表CRH_Car的字段：" + column.HeaderText + "，修改前为：" + _tempValue + "，修改为：" +
        ...
        private static void CRH_Car_dgv_CellEnter(object sender, DataGridViewCellEventArgs e)
        {
            ...
            var rect = _dgv.GetCellDisplayRectangle(cell.ColumnIndex, cell.RowIndex, true);
