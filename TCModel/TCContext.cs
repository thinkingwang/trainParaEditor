...
namespace TCModel
{
    public partial class TCContext : ModelContext
    {
        public TCContext(string conStr)
            : base(conStr)
        {
        }

        public virtual DbSet<CRH_Car> Crh_Cars { get; set; }
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<TCthreshold>()
                .Property(e => e.trainType)
                .IsUnicode(false);
